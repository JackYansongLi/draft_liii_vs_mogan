...
\begin{table}[htbp]
    ...
    \setlength{\tabcolsep}{3pt}
    \caption{
        Comparison between Mogan STEM and alternative editors.
        Sources: Mogan STEM~\cite{moganstem2025},
