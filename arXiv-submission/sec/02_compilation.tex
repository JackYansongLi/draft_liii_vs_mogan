...
\begin{example}[Cross-reference before definition]
\begin{verbatim}
...
Example~4 shows a cross-reference before its definition. The first compilation shows \texttt{??} for the reference, requiring a second pass to resolve.
