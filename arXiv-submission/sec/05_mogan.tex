...
Its Scheme representation\footnote{In fact, the real code written in Mogan's \texttt{.tmu} files is XML-like formatted instead of Scheme. These two formats can be converted losslessly in Mogan. Note that AI is most sensitive to XML syntax, The document of Mogan is conductive to the training and task performance of LLMs.} is shown in Listing~\ref{lst:scheme-integral}:
