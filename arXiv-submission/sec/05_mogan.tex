...
Starting last year, the maintainers of the Chinese TeXmacs community have developed Mogan STEM~\cite{moganstem2025} and a commercial version, Liii STEM~\cite{liiistem2025}, based on GNU TeXmacs. Currently, Mogan STEM and TeXmacs stand as the world's only WYSIWYG structured editors. Table~\ref{tab:mogan-vs-other} compares Mogan STEM with several other editors currently available on the market.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcccc}
        ...
        \midrule
        \textbf{Mogan STEM\cite{moganstem2025}} & Yes              & Yes                 & Yes                      & Partial                       \\
        \textbf{TeXmacs\cite{van_der_hoeven_gnu_2001}}    & Yes              & Yes                 & Partial                  & Partial                       \\
        \textbf{TeX/LaTeX\cite{lamport1994document}}  & No               & Yes                 & Partial                  & Full                          \\
        \textbf{Word}       & Yes              & No                  & Partial                  & Incompatible                  \\
        \textbf{LyX\cite{jackson2001lyx}}        & Partial          & Yes                 & Partial                  & Full                          \\
        \textbf{Typst\cite{madje2023typst}}      & No               & Yes                 & Yes                      & Partial                       \\
        \bottomrule
    \end{tabular}
\end{table}
