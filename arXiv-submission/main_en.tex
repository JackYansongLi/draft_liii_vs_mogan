...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/texlive-size.png}
...
This has led to a fragmented ecosystem where package quality varies widely, and compatibility issues are common.
...
Mogan STEM is a WYSIWYG structured editor designed to address the limitations of LaTeX while maintaining its strengths in scientific typesetting. The key innovations of Mogan STEM include:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/full-compile.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/writing.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/fine-tune.png}
